...
Animotum assumes GPS data are truth - maybe this assumption is ok given that the resolution of the spatial data way exceeds the error margins of FGPS.
Solution to this found 21/09/2023 (setting up table of sd by number of satellites). 
```{r}
...
```
Pre-filtering resulted in improved fits!
Not enough data in some Raine post-nesting or split-up tracks
```{r}
