...
Outputs from Pseudoabsences.R & AppendtoEnviroData.Rmd="20240806AppendedAll.csv", contains three data types:

1.  "track" = presences
2.  "background" = background pseudo-absences
3.  "crw" = correlated random walk pseudo-absences
