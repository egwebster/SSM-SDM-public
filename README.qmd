...
# Foraging habitat for green turtles in the Great Barrier Reef: characterisation, spatial distribution & temporal trend 
...
loaded via a namespace (and not attached):
 [1] gtable_0.3.4      dplyr_1.1.2       compiler_4.3.1    visdat_0.6.0      tidyselect_1.2.0  Rcpp_1.0.11       spatialEco_2.0-2  scales_1.2.1     
...
Presences: 20240212_track.csv
Background pseudo-absences: 20240222backgrounddata_clipped.csv
Correlated random walk pseudo-absences: 20240309data.crw.csv
...
Raw data included the additional fields: 
...
- lc: ARGOS location class, set to G for FGPS. The data contain ARGOS location classes 1,2,3 only. 


**Secondary data** - "rasters for grid predictions". Excludes MMP grids (exposure and frequency).

CRS - Australian Albers GDA93
grid size - 500m 
origin - 
